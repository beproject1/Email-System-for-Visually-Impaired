...
class CheckMailbox(ImapServer.ImapServerClass):
    ...
    def searchMailbox(self,particular_phrase):
        ...
        for email_message in self.normal_emails_all:
            flagPhraseFound = 0
            if(particular_phrase.casefold() in email_message['from'].casefold()):
                flagPhraseFound = 1
            elif(particular_phrase.casefold() in email_message['subject'].casefold()):
                flagPhraseFound = 1
            for email_message in self.normal_emails_all:
...
if __name__ == "__main__":
    ...
    check_mailbox.checkMailboxForParticularPhrase("testing")
