...
class CheckMailbox(ImapServer.ImapServerClass):
    ...
    def selectAppropriateMailbox(self):
        self.my_mail.select('"[Gmail]/Drafts"')
...
##    def continueThisOperation(self, choiceOfUser):
##        print(choiceOfUser)
##        
##        if(("1".casefold() in choiceOfUser.casefold()) or ("one".casefold() in choiceOfUser.casefold())):
##            return 1
##        else:
##            return 0
##        
